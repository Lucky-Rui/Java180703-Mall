					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								<th scope="row">
									<label class="checked-label"><input type="checkbox"><i></i>
										<div class="img"><img src="${ctx}/static/front/images/temp/M-003.jpg" alt="" class="cover"></div>
									</label>
								</th>
								<td>
								...
								<td>¥20.0</td>
								<td><a href="${ctx}/static/front/">删除</a></td>
							</tr>
							<tr>
								<th scope="row">
									<label class="checked-label"><input type="checkbox"><i></i>
										<div class="img"><img src="${ctx}/static/front/images/temp/S-005.jpg" alt="" class="cover"></div>
									</label>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<label class="checked-label"><input type="checkbox"><i></i>
										<div class="img"><img src="${ctx}/static/front/images/temp/M-007.jpg" alt="" class="cover"></div>
									</label>
								</th>
								<td>
